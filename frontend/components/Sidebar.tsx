    ...
    <div style={{
      ...
      <div style={{ padding: '24px 20px 20px', borderBottom: '1px solid rgba(255,255,255,0.09)' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 13 }}>
          ...
          <div style={{
            ...
            boxShadow: '0 4px 20px rgba(245,121,33,0.50)',
          }}>
        ...
        {NAV.map(item => {
          ...
          return (
            <Link key={item.href} href={item.href} style={{ textDecoration: 'none', display: 'block', marginBottom: 5 }}>
              ...
              onMouseEnter={e => { if (!active) { const d = e.currentTarget as HTMLDivElement; d.style.background = 'rgba(255,255,255,0.10)'; d.style.borderColor = 'rgba(255,255,255,0.14)'; }}}
              onMouseLeave={e => { if (!active) { const d = e.currentTarget as HTMLDivElement; d.style.background = 'rgba(255,255,255,0.055)'; d.style.borderColor = 'rgba(255,255,255,0.08)'; }}}
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div style={{ color: active ? 'white' : 'rgba(255,255,255,0.65)', flexShrink: 0, transition: 'color 160ms' }}>
                    {item.icon}
                  </div>
                  <span style={{
                ...
                {item.label === 'Alerts' && unread > 0 && (
                  <span style={{
                    background: active ? 'rgba(255,255,255,0.28)' : '#FF4757',
      ...
      <div style={{ padding: '16px 16px 20px' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 2px' }}>
          ...
          <span style={{
            fontSize: 10, fontWeight: 700, color: '#F57921',
            background: 'rgba(245,121,33,0.15)',
            border: '1px solid rgba(245,121,33,0.30)',
